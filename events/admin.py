...
from .models import EmailSettings, Event, EventImage, Location, WeatherData
...
class EventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Основная информация", {"fields": ("title", "description", "author", "status")}),
        ("Место и Время", {"fields": ("location", "pub_date", "start_date", "end_date")}),
        ("Дополнительно", {"fields": ("rating", "thumbnail")}),
    )
